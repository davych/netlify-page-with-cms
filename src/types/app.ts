...
export type About = SystemFields<'ContentfulAbout'> & {
    heading: EntryFields.Symbol;
};

export type Profile = SystemFields<'ContentfulProfile'> & {
    name: EntryFields.Symbol;
    title: EntryFields.Symbol;
    image: CustomFields.Image;
    bio: CustomFields.Markdown;
};
...
export type ContentObject = Button | StatItem | Stats | Hero | About | Profile | ComposablePage;
